...
- (void)setDateLabelText:(UILabel *)label component:(NSInteger)component row:(NSInteger)row {
    if (self.showType == BRDatePickerModeYMDHM) {
        if (component == 0) {
            label.text = [NSString stringWithFormat:@"%@%@", self.yearArr[row],KLocalizedString(@"year")];
        } else if (component == 1) {
            label.text = [NSString stringWithFormat:@"%@%@", self.monthArr[row],KLocalizedString(@"month")];
        } else if (component == 2) {
            label.text = [NSString stringWithFormat:@"%@%@", self.dayArr[row],KLocalizedString(@"day")];
        } else if (component == 3) {
