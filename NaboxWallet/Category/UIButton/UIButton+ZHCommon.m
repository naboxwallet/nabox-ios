...
#import "UIButton+ZHCommon.h"
#import <objc/runtime.h>

@implementation UIButton (ZHCommon)
...
- (void)setTouchEnable:(BOOL)enable
{
    self.enabled = enable;
    if (enable) {
        self.backgroundColor = [UIColor colorWithRed:83/255.0f green:184/255.0f blue:169/255.0f alpha:1];
    }else{
        self.backgroundColor = [UIColor colorWithRed:83/255.0f green:184/255.0f blue:169/255.0f alpha:0.6];
    }
}
