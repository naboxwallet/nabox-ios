...
#import "NSString+ZHRegEx.h"

@implementation NSString (ZHRegEx)
#pragma mark - 正则相关
...
/** 企业统一社会信用代码的有效性 */
- (BOOL)isEnterpriseUnifiedSocialCreditCode
{
    NSString *emailRegex = @"^([159Y]{1})([1239]{1})([0-9ABCDEFGHJKLMNPQRTUWXY]{6})([0-9ABCDEFGHJKLMNPQRTUWXY]{9})([0-90-9ABCDEFGHJKLMNPQRTUWXY])$";
    return [self isValidateByRegex:emailRegex];
}
...
- (BOOL)isPassword
{
    NSString *emailRegex = @"^(?![\\d]+$)(?![a-zA-Z]+$)(?![`~!@#$%^]+$)[\\da-zA-Z`~!@#$%^]{6,20}$";
    return [self isValidateByRegex:emailRegex];
}
